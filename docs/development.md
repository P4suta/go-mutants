...
The numbers the gate is sized against: 2722 mutants catalogued, 2659 detected —
2653 killed, two of them by the memory bound, and six caught by the per-mutant
...
With that in place the whole summary is stable: the same 2722 / 2653 / 6 / 63 on
...
same arithmetic once more: half a percent of 2659 is thirteen survivors
(2646/2659 clears, 2645/2659 does not), one more than when the number was set
