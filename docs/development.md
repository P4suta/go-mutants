...
The numbers the gate is sized against: 2716 mutants catalogued, 2653 detected —
2647 killed, two of them by the memory bound, and six caught by the per-mutant
...
With that in place the whole summary is stable: the same 2716 / 2647 / 6 / 63 on
...
same arithmetic once more: half a percent of 2653 is thirteen survivors
(2640/2653 clears, 2639/2653 does not), one more than when the number was set
