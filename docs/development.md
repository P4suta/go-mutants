...
The numbers the gate is sized against: 2689 mutants catalogued, 2626 detected —
2620 killed, two of them by the memory bound, and six caught by the per-mutant
...
With that in place the whole summary is stable: the same 2689 / 2620 / 6 / 63 on
...
same arithmetic once more: half a percent of 2626 is thirteen survivors
(2613/2626 clears, 2612/2626 does not), one more than when the number was set
