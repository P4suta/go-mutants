...
The numbers the gate is sized against: 2736 mutants catalogued, 2673 detected —
2667 killed, two of them by the memory bound, and six caught by the per-mutant
...
With that in place the whole summary is stable: the same 2736 / 2667 / 6 / 63 on
...
same arithmetic once more: half a percent of 2673 is thirteen survivors
(2660/2673 clears, 2659/2673 does not), one more than when the number was set
